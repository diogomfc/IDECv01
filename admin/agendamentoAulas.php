  ...
  <tr>
    <td width="1023" height="451" valign="top"><table width="984">
      ...
      <tr>
        ...
        <td width="755"><a href="professor.php"><img src="../img/BTAgendar.png" alt="" width="154" height="32" /></a></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td height="84">&nbsp;</td>
      ...
      <tr>
        <td height="60" colspan="3" valign="top"><table width="984" border="0">
          ...
          <?php do { ?>
            <tr>
            <td class="aa" bgcolor="#ECF3F7"><?php echo $row_ListarAgenda['professor']; ?></td>
              <td class="aa" bgcolor="#ECF3F7"><?php echo $row_ListarAgenda['curso']; ?></td>
              <input name="idpolos" type="hidden" value="<?php echo $ids_turmas = $row_ListarAgenda['turma']; ?>" />
              ...
              <td width="24" bgcolor="#ECF3F7"><span style="font-weight: bold; font-family: Calibri; color: #F00; text-align: center;"><a href="../pgsExcluir/ExcluirAgendamento.php?id=<?php echo $row_ListarAgenda['id']; ?>"></a></span><a href="../pgsExcluir/ExcluirAgendamento.php?id=<?php echo $row_ListarAgenda['id']; ?>"><img src="../img/Delete.png" alt="" width="24" height="24" title="EXCLUIR AGENDAMENTO" /></a></a></td>
            </tr>
            <tr>
