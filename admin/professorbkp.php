      ...
      <tr>
        ...
        <td valign="top"><table width="964" align="left">
          ...
          <tr>
            ...
            <td align="center" bgcolor="<?php if ($i%2==0){ echo "#F8F8F8"; } ?>"><span style="font-weight: bold; font-family: Calibri; color: #F00;"> <a href="../pgsExcluir/ExcluirProfessores.php?id=<?php echo $row_Prof['id']; ?>"><img src="../img/Delete.png" alt="" title="EXCLUIR PROFESSOR" width="24" height="24" /></a> <a href="../pgsCadastros/AlterarProfessores.php?id=<?php echo $row_Prof['id']; ?>"><img src="../img/Modify.png" alt="" title="ALTERAR CADASTRO DO PROFESSOR" width="24" height="24" /></a> <a href="#"><img src="../img/Profile.png" alt="" title="PERFIL DO PROFESSOR" width="24" height="24" /></a><a href="../pgsCadastros/CadastroMatriculas.php?id_estudantes=<?php echo $row_Prof['id']; ?>"><a class="a" rel="superbox[iframe][1200x500]" href="pgsCadastros/historicoMatriculas.php?code=<?php echo $row_Prof['code']; ?>"></a></span></td>
          </tr>
