      ...
      <tr>
        ...
        <td valign="top"><table width="964" align="left">
          <tr>
            ...
            <td width="120"><span style="font-family: Calibri; color: #B7302A; font-weight: bold; font-size: 18px; text-align: center;">CPF:</span></td>
            <td width="525"><span style="font-family: Calibri; color: #B7302A; font-weight: bold; font-size: 18px; text-align: center;">NOME:</span></td>
            <td width="75"><span style="font-family: Calibri; color: #B7302A; font-weight: bold; font-size: 18px; text-align: center;">TELEFONES:</span></td>
            <td width="143" align="center"><span style="font-family: Calibri; color: #B7302A; font-weight: bold; font-size: 18px;">GERÊNCIAR</span></td>
          </tr>
          <?php $i = 0;
			
			do { ?>
          <tr>
          <input name="" type="hidden" value="<?php echo $celular = $row_Estd['celular'];  ?>" />
          <input name="" type="hidden" value="<?php echo $tel_residencial = $row_Estd['tel_residencial'];  ?>" />
          <input name="" type="hidden" value="<?php echo $tel_comercial = $row_Estd['tel_comercial'];  ?>" />
            <td width="77" height="31" bgcolor="<?php if ($i%2==0){ echo "#F8F8F8"; } ?>"><span style="text-align: center; color: #1B4871; font-family: Calibri; font-size: 18px;"><?php echo $row_Estd['code']; ?></span></td>
            <td width="120" bgcolor="<?php if ($i%2==0){ echo "#F8F8F8"; } ?>"><span style="text-align: center; color: #1B4871; font-family: Calibri; font-size: 18px;"><?php echo $row_Estd['cpf']; ?></span></td>
            <td width="525" bgcolor="<?php if ($i%2==0){ echo "#F8F8F8"; } ?>"><span style="font-weight: bold; text-align: center; color: #1B4871; font-family: Calibri; font-size: 18px;"><?php echo $row_Estd['nome']; ?></span></td>
            <td width="75" align="center" bgcolor="<?php if ($i%2==0){ echo "#F8F8F8"; } ?>" class="SSS"><a href=""><img src="../img/IMGtelefones1.png" width="30" height="22" title=" 
<?php echo $celular; ?> 
<?php echo $tel_residencial; ?> 
<?php echo $tel_comercial; ?>"/></a></td>
      ...
      <tr>
        <td height="32">&nbsp;</td>
        <td valign="bottom" class="total">Total de registros: <?php echo $totalRows_Estd ?></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
