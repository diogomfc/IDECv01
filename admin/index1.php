...
<body><table width="997" height="717" align="center" style="background: url(../img/imgFundoGerenciamento2.png) no-repeat; color: #1B4871; font-family: Calibri;">
  <tr>
    <td width="140" valign="top" class="" ><table width="984">
      <tr>
        ...
        <td width="955" align="right" valign="top"><table width="462">
          <tr>
            ...
            <td width="131">&nbsp;</td>
            <td width="103">&nbsp;</td>
            <td width="34"><a href="#"><img src="../img/btInfo.png" width="28" height="30" title="Informação do Sistema"/></a></td>
      ...
      <tr>
        ...
        <td valign="top"><table width="984" height="240">
          <tr>
            ...
            <td width="121"><a href="turmas.php"><img name="btpolos" src="../img/btpolos.png" width="116" height="113" border="0" id="btpolos" alt="" title="Polos" /></a></td>
            ...
            <td width="184"><a href="#"><img src="../img/btCertificados.png" width="110" height="95" title="Certificados" /></a></td>
          </tr>
          <tr>
            <td height="117">&nbsp;</td>
            <td><a href="../financeiro/index.php"><img name="btfinanceiro" src="../img/btfinanceiro.gif" width="116" height="113" border="0" id="btfinanceiro" alt="" title="Financeiro" /></a></td>
            <td><a href="#"><img name="btusuarios" src="../img/btusuarios.gif" width="116" height="113" border="0" id="btusuarios" alt="" title="Usuários" /></a></td>
            <td><a href="#"><img src="../img/btRelatorio.png" width="99" height="104"  title="Relatórios"/></a></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
      ...
      <tr>
        <td height="50">&nbsp;</td>
        <td valign="middle"><span class="aajj">Existem <?php echo $totalRows_rs_estudantes ?> Alunos,<?php echo $totalRows_rs_professores ?> Pofessores, 10 Vendedores Cadastrados</span></td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
