...
function SomenteMaiusculo(e){
	...
	var obs2 = new CaixaAltaMask(document.getElementById("obs2"));
  ...
  <tr>
    <td width="978" height="956" align="left" valign="top"><table width="978" height="1167">
      ...
      <tr>
        ...
        <td height="892" colspan="3" align="left" valign="top"><form action="uploadCadastroAlunos.php" method="post" enctype="multipart/form-data" onkeypress='return SomenteMaiusculo(event)'>
          <table width="961" height="724">
            <tr>
	...
	$sql_1 = mysql_query("SELECT * FROM idec_estudantes ORDER BY id DESC LIMIT 1");
	  ...
	  $new_code = rand($max,$mim);
	   ?>
            ...
            <tr>
              <td height="12" style="text-align: right">Estado Civil:</td>
            ...
            <tr>
              <td height="13" style="text-align: right">CEP:</td>
              <td colspan="4"><span id="sprytextfield14">
              <label for="cep"></label>
            ...
            <tr>
              <td height="13" style="text-align: right">Bairro:</td>
              <td colspan="4" align="left"><span style="text-align: left"><span id="sprytextfield7">
              <label for="bairro"></label>
              <input name="bairro" type="text" id="bairro" size="40" style="text-transform:uppercase;"/>
              </span></span></td>
</tr>
            <tr>
              <td height="13" style="text-align: right">Endereço:</td>
              <td colspan="4"><span id="sprytextfield5">
              <label for="endereco"></label>
              <input name="endereco" type="text" id="endereco" size="60" style="text-transform:uppercase;" />
