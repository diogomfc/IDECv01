...
mysql_select_db($database_ConexaoIdec, $ConexaoIdec);
$query_rs_cursos = "SELECT * FROM idec_cursos ORDER BY cursos ASC";
...
mysql_select_db($database_ConexaoIdec, $ConexaoIdec);
$query_rs_representantes = "SELECT * FROM ide_representantes ORDER BY nome ASC";
...
$colname_rs_estudantes2 = "-1";
if (isset($_GET['estudante_id'])) {
  $colname_rs_estudantes2 = $_GET['estudante_id'];
}
mysql_select_db($database_ConexaoIdec, $ConexaoIdec);
$query_rs_estudantes2 = sprintf("SELECT * FROM idec_estudantes WHERE code = %s", GetSQLValueString($colname_rs_estudantes2, "text"));
$rs_estudantes2 = mysql_query($query_rs_estudantes2, $ConexaoIdec) or die(mysql_error());
$row_rs_estudantes2 = mysql_fetch_assoc($rs_estudantes2);
$totalRows_rs_estudantes2 = mysql_num_rows($rs_estudantes2);
?>
	  ...
	  $new_code = rand($max,$mim);
	   ?>
            ...
            <tr>
              ...
              <td colspan="3"><input name="nomeEstudante" type="text" id="nomeEstudante" style="font-family:Calibri; font-size:20px; color:#000; font-weight:bold; border:none; background-color: transparent; " value="<?php echo $row_rs_estudantes['nome']; ?><?php echo $row_rs_estudantes2['nome']; ?>" size="50" readonly="readonly" />
                <input name="nomeEstudante" type="hidden" value="<?php echo $row_rs_estudantes['nome']; ?><?php echo $row_rs_estudantes2['nome']; ?>" />
                RM:
                <label for="estudante_id"></label>
                <input name="estudante_id" type="text" id="estudante_id" style="font-family:Calibri; font-size:20px; color:#099; border:none; background-color: transparent; " value="<?php echo $row_rs_estudantes['code']; ?><?php echo $row_rs_estudantes2['code']; ?>" size="10" readonly="readonly" />
                <input name="estudante_id" type="hidden" value="<?php echo $row_rs_estudantes['code']; ?><?php echo $row_rs_estudantes2['code']; ?>" /></td>
              </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="3"><select name="id_curso" size="1" style="font-family:Calibri; font-size:18px; color:#000; text-transform:uppercase;" onchange="nomesCurso(this.value)">
...
?>
            ...
            <tr>
              ...
              <td colspan="3"><label for="disciplinas"></label>
                <textarea name="disciplinas" cols="80" rows="3" readonly="readonly" id="disciplinas" style="font-family:Calibri; font-size:18px; color:#000;">
                </textarea></td>
              </tr>
            <tr>
              <td height="26" colspan="2"  style="text-align: right; font-size: 20px; font-family: Calibri;">Polo/Turma:</td>
              <td colspan="3"><select name="polo" size="1" style="font-family:Calibri; font-size:18px; color:#000; text-transform:uppercase;" onchange="nomesPolo(this.value)">
...
?>
            ...
            <tr>
              ...
              <td colspan="3"><label for="representante"></label>
                <select name="representante" size="1" id="representante" style="font-family:Calibri; font-size:18px; color:#000; text-transform:uppercase;">
...
mysql_free_result($rs_estudantes2);
?>
