...
?>
  ...
  <tr>
    ...
    <td width="88"><form id="form2" name="form2" method="post" action="">
      <label>
        <input name="Cadastrar" type="image" src="../img/BTNovoAluno2.png" id="Cadastrar" onclick="MM_goToURL('parent','CadastroEstudante1.php');return document.MM_returnValue"/>
      </label>
    </form></td>
