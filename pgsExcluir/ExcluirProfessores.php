...
if (isset($_GET['id'])) {
  $colname_rs_professores = $_GET['id'];
}
mysql_select_db($database_ConexaoIdec, $ConexaoIdec);
...
<table width="1016" height="246" border="0" align="center" style="background:url(../img/imgFundoExcluirProfessores.png) no-repeat">
  <tr>
    <td width="978" height="242"><form id="form1" name="form1" method="post" action="">
      <table width="549" height="213" align="center">
        <tr>
          <td height="181" colspan="3"><p>Tem certeza que deseja excluir esse PROFESSOR:</p>
            <p><?php echo $row_rs_professores['nome']; ?></p>
            <p></p></td>
        </tr>
        <tr>
          <td width="219" height="24"><input name="id" type="hidden" id="id" value="<?php echo $row_rs_professores['id']; ?>" /></td>
          <td width="99"><input type="submit" name="button" id="button" value="SIM" />
            <input name="button2" type="submit" id="button2" onclick="MM_goToURL('parent','../admin/professor.php');return document.MM_returnValue" value="NÃO" /></td>
          <td width="215">&nbsp;</td>
        </tr>
      </table>
    </form></td>
