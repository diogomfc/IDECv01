...
mysql_select_db($database_ConexaoIdec, $ConexaoIdec);
$query_Recordset1 = sprintf("SELECT * FROM idec_polos WHERE id = %s", GetSQLValueString($colname_Recordset1, "int"));
...
<table width="1016" height="246" border="0" align="center" style="background:url(../img/imgFundoExcluirPolos.png) no-repeat">
  <tr>
    <td width="978" height="242"><form id="form1" name="form1" method="post" action="">
      <table width="549" height="213" align="center">
        <tr>
          <td height="181" colspan="3"><p>Tem certeza que deseja excluir esse POLO:</p>
        ...
        <tr>
          ...
          <td width="98"><input type="submit" name="button" id="button" value="SIM" />
            <input name="button2" type="submit" id="button2" onclick="MM_goToURL('parent','../admin/polos.php');return document.MM_returnValue" value="NÃO" /></td>
          <td width="216">&nbsp;</td>
        </tr>
      </table>
    </form></td>
