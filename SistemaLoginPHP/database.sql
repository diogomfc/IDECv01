...
--
-- Banco de Dados: `sitema_idec`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `idec_acesso_ao_sistema`
--

DROP TABLE IF EXISTS `idec_acesso_ao_sistema`;
CREATE TABLE IF NOT EXISTS `idec_acesso_ao_sistema` (
...
INSERT INTO `idec_acesso_ao_sistema` (`id`, `nome`, `usuario`, `senha`, `email`, `nivel`, `ativo`, `cadastro`) VALUES
